...
const GMATPage = () => {
  return (
    ...
    <div>
      ...
      <div className="relative bg-cover bg-center h-96" style={{ backgroundImage: `url(${ieltseducation})` }}> 
        <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
          <div className="text-center text-white">
            <h1 className="text-4xl font-bold">Best GMAT Coaching in the Town</h1>
            <p className="mt-4">
      ...
      <div className="py-12 bg-gray-50">
        <h2 className="text-center text-3xl font-bold mb-8">How is GMAT Test Scored Calculated?</h2>
        <div className="max-w-4xl mx-auto text-center">
          <p className="mb-4">
            The GMAT test is scored on a band scale of 0–9 in each section (listening, reading, writing, and speaking),
    ...
    <section className="bg-white py-16 px-8">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-3xl font-bold text-center text-red-600 mb-8">
          Crack GMAT with 7+ Bands in 30 Days With us
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-6 mb-16">
          <div className="text-center">
            ...
            <p className="text-sm text-gray-600">
              Receive guidance from the finest GMAT trainers to excel in your preparation.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <h3 className="font-semibold">360 Degree GMAT Excellence</h3>
            <p className="text-sm text-gray-600">
              Over 30 hours of coaching to master every aspect of GMAT.
            </p>
          </div>
