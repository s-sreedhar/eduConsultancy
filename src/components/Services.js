...
const Services = () => {
    return (
      ...
      <div className="absolute inset-0 flex items-center justify-center text-center">
        <h1 className="text-4xl font-bold text-red-700">We Make Your Dreams Come True</h1> 
      </div>
    </div>
        {/* Section 2: Approach */}
    <div className="bg-white text-gray-800 py-10 px-6 md:px-20">
      ...
      <ul className="space-y-4">
        <li>
          <strong className="text-blue-600">Counselling:</strong> Over 10
          Get expert advice tailored to your goals.
        </li>
        <li>
          <strong className="text-blue-600">Test Preparation</strong>{" "}
          Ace your tests with personalized coaching.
        </li>
        <li>
          <strong className="text-blue-600">Course Selection:</strong>{" "}
          Find the perfect course for your career.
        </li>
        <li>
          <strong className="text-blue-600">University Selection:</strong> Coached
          Choose the best university for your needs.
        </li>
        <li>
          <strong className="text-blue-600">Visa Assistance:</strong>{" "}
          Simplify your visa process with our help.
        </li>
        <li>
          <strong className="text-blue-600">Financial Planning:</strong>{" "}
          Plan your finances effectively for study abroad.
        </li>
        <li>
          <strong className="text-blue-600">Accommodation:</strong>{" "}
          Find comfortable housing abroad with ease.
        </li>
        <li>
          <strong className="text-blue-600">Post-Arrival Support:</strong>{" "}
